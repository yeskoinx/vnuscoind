...
const uint32_t UPGRADE_HEIGHT_V2                             = 0; // Diff algo Change from cryptonote default to lwma
const uint32_t UPGRADE_HEIGHT_V3                             = 1; // POW algo Change from cryptonote default to cnv7 Anti ASIC
